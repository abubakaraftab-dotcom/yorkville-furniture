        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <Link href="/" className="flex items-center gap-2 mb-4">
              <img src={`${process.env.NEXT_PUBLIC_BASE_PATH ?? ""}/images/logo-white-card.png`} alt="Yorkville Furniture Logo" className="h-28 w-auto object-contain rounded-lg border border-white/20 shadow-lg" />
